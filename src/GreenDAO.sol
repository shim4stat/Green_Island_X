    ...
    GovernorTimelockControl
{
    ...
    // WIP: SubDAO作成のための関数、パラメータなどは要検討
    function createSubDAO(string memory name) public returns (address) {
        Green_SubDAO subDAO = new Green_SubDAO(name);
        return address(subDAO);
    }
